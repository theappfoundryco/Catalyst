...
final class LegalConsentViewModel: ObservableObject {
    ...
    /// Effective "current" versions: the NEWER of what this build ships and what the last
    /// successful remote check reported. URLs are stable constants, so they never need caching.
    ///
