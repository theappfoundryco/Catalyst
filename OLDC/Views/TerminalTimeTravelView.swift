...
struct TerminalTimeTravelView: View {
    ...
    struct CommandRow: View {
        ...
        let onCopy: () -> Void
        let onRun: () -> Void
        // Local UI feedback: flash "Copied" + green tick for 2s, then revert — mirrors the
        // shared CopyButton (UserProfileView) so copy affordances behave the same app-wide.
