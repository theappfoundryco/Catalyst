...
///
/// **Single source of truth** for the simple icon + text banners shown in the sign-in window
/// (errors) and reused wherever a one-line status call-out is needed. Richer banners with a
/// spinner or dismiss button (e.g. the profile sheet's manage banner) compose their own body
/// and apply ``statusBannerChrome(tint:cornerRadius:)`` instead.
